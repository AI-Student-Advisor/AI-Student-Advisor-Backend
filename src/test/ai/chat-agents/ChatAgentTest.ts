...
import { getWebBaseLoader } from "/ai/data-loaders/WebDataLoaders.js";
...
function cli(chatAgent: ChatAgent) {
  TU.print(
    `\nCLI-based AI Student Advisor ready for your query related to ${TEST_PARAMS.data_context}. Type 'exit' to exit.\n`
  );
  // start prompt
